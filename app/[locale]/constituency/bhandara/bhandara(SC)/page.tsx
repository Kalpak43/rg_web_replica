      ...
      >
        <div className="px-4 md:px-10">
          ...
          <div className="mt-5 bg-gray-100 ">
            <Breadcrumb pageName={t("bhandara")} />
          </div>
          ...
          >
            ...
            <div className="border-2 border-black divide-y-2 divide-black">
              <div className="grid grid-cols-3 divide-x-2 divide-black">
                ...
                <p className="p-2">{t("ram")}</p>
                <p className="p-2">{t("INC")}</p>
              </div>
              <div className="grid grid-cols-3 divide-x-2 divide-black">
                <p className="p-2">1957</p>
                <span>
                  <p className="p-2">{t("sitaram")}</p>
                  <p className="p-2">{t("dada")}</p>
                </span>
                <p className="p-2">{t("INC")}</p>
              </div>
              <div className="grid grid-cols-3 divide-x-2 divide-black">
                ...
                <p className="p-2">{t("dada")}</p>
                <p className="p-2">{t("ip")}</p>
              </div>
              <div className="grid grid-cols-3 divide-x-2 divide-black">
                <p className="p-2">1968</p>
                <p className="p-2">{t("nasikrao")}</p>
                <p className="p-2">{t("INC")}</p>
              </div>
              <div className="grid grid-cols-3 divide-x-2 divide-black">
                <p className="p-2">1972</p>
                <p className="p-2">{t("govind")}</p>
                <p className="p-2">{t("ip")}</p>
              </div>
              <div className="grid grid-cols-3 divide-x-2 divide-black">
                <p className="p-2">1978</p>
                <p className="p-2">{t("vittal")}</p>
                <p className="p-2">{t("INC")}</p>
              </div>
              <div className="grid grid-cols-3 divide-x-2 divide-black">
                <p className="p-2">1980</p>
                <p className="p-2">{t("madhavrao")}</p>
                <p className="p-2">{t("ip")}</p>
              </div>
              <div className="grid grid-cols-3 divide-x-2 divide-black">
                <p className="p-2">1985</p>
                <p className="p-2">{t("anadrao")}</p>
                <p className="p-2">{t("INC")}</p>
              </div>
              <div className="grid grid-cols-3 divide-x-2 divide-black">
                <p className="p-2">1990</p>
                <p className="p-2">{t("ramgopal")}</p>
                <p className="p-2">{t("BJP")}</p>
              </div>
              <div className="grid grid-cols-3 divide-x-2 divide-black">
                <p className="p-2">2004</p>
                <p className="p-2">{t("nana")}</p>
                <p className="p-2">{t("NCP")}</p>
              </div>
              <div className="grid grid-cols-3 divide-x-2 divide-black">
                <p className="p-2">2009</p>
                <p className="p-2">{t("narendra")}</p>
                <p className="p-2">{t("ss")}</p>
              </div>
              <div className="grid grid-cols-3 divide-x-2 divide-black">
                <p className="p-2">2014</p>
                <p className="p-2">{t("ramchandra")}</p>
                <p className="p-2">	{t("BJP")}</p>
              </div>
              <div className="grid grid-cols-3 divide-x-2 divide-black">
