          ...
          >
            ...
            <div className="border-2 border-black divide-y-2 divide-black">
              ...
              <div className="grid grid-cols-3 divide-x-2 divide-black">
                ...
                <p className="p-2">{t("keshavrao")}</p>
                <p className="p-2">{t("INC")}</p>
              </div>
              <div className="grid grid-cols-3 divide-x-2 divide-black">
                <p className="p-2">1978</p>
                <p className="p-2">{t("subhash")}</p>
                <p className="p-2">{t("INC")} (I)</p>
              </div>
              <div className="grid grid-cols-3 divide-x-2 divide-black">
                <p className="p-2">1985</p>
                <p className="p-2">{t("ishwar")}</p>
                <p className="p-2">{t("JP")}</p>
              </div>
              <div className="grid grid-cols-3 divide-x-2 divide-black">
              ...
              <div className="grid grid-cols-3 divide-x-2 divide-black">
                ...
                <p className="p-2">{t("madhukar")}</p>
                <p className="p-2">{t("BJP")}</p>
              </div>
              <div className="grid grid-cols-3 divide-x-2 divide-black">
                <p className="p-2">2009</p>
                <p className="p-2">{t("anil")}</p>
                <p className="p-2">{t("INC")}</p>
              </div>
              <div className="grid grid-cols-3 divide-x-2 divide-black">
                <p className="p-2">2014</p>
                <p className="p-2">{t("charan")}</p>
                <p className="p-2">{t("BJP")}</p>
              </div>
              <div className="grid grid-cols-3 divide-x-2 divide-black">
                <p className="p-2">2019</p>
                <p className="p-2">{t("raju")}</p>
